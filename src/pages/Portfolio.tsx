      ...
      <AnimatePresence>
        {selectedId && selectedProject && (
          ...
          >
            ...
            >
              <div className="w-full md:w-3/5 h-[40vh] md:h-auto relative bg-charcoal">
                <img 
              ...
              <div className="w-full md:w-2/5 p-8 md:p-12 flex flex-col">
                ...
                <p className="text-lg text-charcoal/80 leading-relaxed mb-12 flex-grow">
                  {selectedProject.description}
                </p>
                
                <div className="grid grid-cols-2 gap-8 border-t border-steel/30 pt-8">
                  <div>
