    ...
    <main className="bg-concrete min-h-screen">
      ...
      <section className="p-8 md:p-16 max-w-7xl mx-auto py-24">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display text-4xl mb-8">Open Positions</h2>
          <p className="text-charcoal/70 mb-12 font-light leading-relaxed text-lg">
          ...
          <a href="mailto:careers@danuthiaandassociates.com" className="inline-flex items-center justify-between p-6 border border-charcoal hover:bg-charcoal hover:text-concrete transition-all duration-500 group w-full md:w-auto min-w-[300px]">
