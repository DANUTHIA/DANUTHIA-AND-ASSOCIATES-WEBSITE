      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        >
          <motion.div variants={fadeInUp} className="border-b border-charcoal/20 dark:border-concrete/20 pb-12">
            <p className="text-bronze tracking-[0.2em] text-xs font-mono uppercase mb-4">Legal Documentation</p>
          ...
          <motion.div variants={fadeInUp} className="space-y-12 text-charcoal dark:text-concrete">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">1. User Accounts and Security</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">2. Services, Bookings, and Electronic Contracts</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">3. Payment Terms and Bank Transfers</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">4. Cancellation, Refunds, and Rescheduling</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">5. Scope of Professional Services and Built Environment Disclaimer</h2>
              <div className="font-mono text-sm leading-relaxed opacity-80 space-y-4">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">6. AI-Generated Content and Automated Tools</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">7. Intellectual Property Rights</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">8. Restrictions</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">9. User Content</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">10. Disclaimers and Limitation of Liability</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">11. Indemnification</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">12. Data Privacy Integration</h2>
              <p className="font-mono text-sm leading-relaxed opacity-80">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold uppercase tracking-tight mb-4 text-bronze">13. General Provisions</h2>
              <div className="font-mono text-sm leading-relaxed opacity-80 space-y-4">
